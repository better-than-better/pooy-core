class Rules {
  ...
  async requestHandler(rule, ctx) {
    ...
    headers && ctx.setHeaders(headers, request.discardOriginalHeaders);
  ...
  async responseHandler(rule, ctx) {
    ...
    headers && ctx.setHeaders(headers, response.discardOriginalHeaders);
    body && ctx.setBody(body);
